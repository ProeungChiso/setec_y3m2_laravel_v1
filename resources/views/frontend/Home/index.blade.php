    ...
    <section id="hero" class="hero section dark-background">
        ...
        <div class="container">
            ...
            <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
                <a href="{{url('frontend/courses')}}" class="btn-get-started">Get Started</a>
            </div>
        </div>
    ...
    <section id="courses" class="courses section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach ($t_details as $key => $value)
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch g-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="course-item">
                        <img src="{{asset('assets/img/course-1.jpg')}}" class="img-fluid" alt="...">
                        <div class="course-content">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <p class="category text-uppercase">{{$value->major_type}}</p>
                                <p class="price">${{$value->course_price}}</p>
                            </div>

                            <h3 class="text-uppercase"><a href="course-details.html">{{$value->course_name}}</a></h3>
                            ...
                            <div class="trainer d-flex justify-content-between align-items-center">
                                <div class="trainer-profile d-flex align-items-center">
                                    ...
                                    <a href="" class="trainer-link">{{$value->teacher_name}}</a>
                                </div>
